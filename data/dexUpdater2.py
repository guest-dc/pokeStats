...
def format_pokemon_data(pokemon):
    ...
    types = [pokemon["primaryType"]["names"]["English"]]
    if pokemon.get("secondaryType"):
        types.append(pokemon["secondaryType"]["names"]["English"])
    ...
    has_mega = pokemon.get("hasMegaEvolution")
